...
void ProtonsRandom::createHistogram(TString filename){
  ...
  TDirectory *cdir = fileout->mkdir("QuickProtonsAnalysis");
  cdir->cd();    
...
void ProtonsRandom::loadHistogram(TString filename){
  ...
  try{
    hXiRp210Arm45 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiRp210Arm45");
    hXiRp210Arm56 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiRp210Arm56");
    hXiRp220Arm45 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiRp220Arm45");
    hXiRp220Arm56 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiRp220Arm56");
    hXiMultiArm45 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiMultiArm45");
    hXiMultiArm56 = (TH1F*)filein->Get("QuickProtonsAnalysis/hXiMultiArm56");
  }
  catch(...){
...
void ProtonsRandom::Storing(){
  ...
  fileout->cd("QuickProtonsAnalysis"); 
  hXiRp210Arm45->Write();
  hXiRp210Arm56->Write();
  hXiRp220Arm45->Write();
  hXiRp220Arm56->Write();
