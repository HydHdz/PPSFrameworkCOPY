...
class TTreeMissingMass {
  ...
  public:
    ...
    bool switchSingleRpot = false;
    bool switchBasic = true;
    ...
    bool HLT_Mu18_Mu9_SameSign = false;
    bool HLT_Dimuon0_Upsilon_L1_4p5er2p0M = false;
    ...
    bool flagrdm_rp210_Arm45 = false;
    bool flagrdm_rp210_Arm56 = false;
    bool flagrdm_rp220_Arm45 = false;
    bool flagrdm_rp220_Arm56 = false;
    bool flagrdm_multiArm45 = false;
    bool flagrdm_multiArm56 = false;
...
void TTreeMissingMass::Clearing(){
  ...
  HLT_IsoMu24 = false;
  HLT_IsoMu27 = false;
  HLT_Mu18_Mu9_SameSign = false;
  HLT_Dimuon0_Upsilon_L1_4p5er2p0M = false;
  ...
  flagrdm_rp210_Arm45 = 0;
  flagrdm_rp210_Arm56 = 0;
  flagrdm_rp220_Arm45 = 0;
  flagrdm_rp220_Arm56 = 0;
  flagrdm_multiArm45 = 0;
  flagrdm_multiArm56 = 0;
...
void TTreeMissingMass::CreateTTree(TString inputfile){
  ...
  if(!notrigger){
    ...
    if(switchMuon){
      if(switchYear2017||switchYear2018){
	...
	out->Branch("HLT_Mu18_Mu9_SameSign",&HLT_Mu18_Mu9_SameSign,"HLT_Mu18_Mu9_SameSign/B");
	out->Branch("HLT_Dimuon0_Upsilon_L1_4p5er2p0M",&HLT_Dimuon0_Upsilon_L1_4p5er2p0M,"HLT_Dimuon0_Upsilon_L1_4p5er2p0M/B");
  ...
  if(switchMC){
    out->Branch("weight",&weight,"weight/D");
    ...
    out->Branch("gendijetMass",&gendijetMass,"gendijetMass/D", 100);
  ...
  if(switchSingleRpot&&(switchMuon||switchElectron)){
  ...
  if(!switchBasic){
    ...
    out->Branch("flagrdm_rp210_Arm45",&flagrdm_rp210_Arm45,"flagrdm_rp210_Arm45/B");
    out->Branch("flagrdm_rp210_Arm56",&flagrdm_rp210_Arm56,"flagrdm_rp210_Arm56/B");
    out->Branch("flagrdm_rp220_Arm45",&flagrdm_rp220_Arm45,"flagrdm_rp220_Arm45/B");
    out->Branch("flagrdm_rp220_Arm56",&flagrdm_rp220_Arm56,"flagrdm_rp220_Arm56/B");
  }
  ...
  out->Branch("flagrdm_multiArm45",&flagrdm_multiArm45,"flagrdm_multiArm45/B");
  out->Branch("flagrdm_multiArm56",&flagrdm_multiArm56,"flagrdm_multiArm56/B");
...
void TTreeMissingMass::Fill(){
  ...
  /*
     ...
     branchList  = out->GetListOfBranches();
     int nBranch     = out->GetNbranches();
     ...
     var[i] = out->GetBranch(varnames[i])->GetLeaf(varnames[i]);
     value_i = var[i]->GetValue();
     std::cout << "Branch Names: " << varnames[i] << ", value: " << value_i << std::endl;
     }
     */
