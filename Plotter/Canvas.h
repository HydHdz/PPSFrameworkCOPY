    ...
    //Copyright, Laurent Forthomme(laurent.forthomme@cern.ch), All rights reserved.
...
class Canvas : public TCanvas
{
 public:
  ...
  inline Canvas( const char* name, const char* title = "", const char* exper = "DESY", const char* type = "Test beam", bool ratio = false, Align label_align = Align::left ) :
